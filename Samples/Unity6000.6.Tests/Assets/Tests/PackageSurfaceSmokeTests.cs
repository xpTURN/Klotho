...
{
    /// <summary>
    /// Unity 6000.6 compatibility smoke: every shipped assembly resolves, and the assembly
    ...
    {
        // This project exists only to validate the newest editor the package is tested against
        // (the declared minimum, package.json "unity": "2022.3", is covered by Unity2022.Tests).
        // Running it on another editor still passes the other fixtures but no longer proves
        // anything about 6000.6, so pin the intent here.
        [Test]
        public void EditorVersion_Is6000_6()
        {
            Assert.IsTrue(Application.unityVersion.StartsWith("6000.6"),
                $"Unity6000.6.Tests must run on the 6000.6 line; " +
