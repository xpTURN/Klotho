// GodotP2pSample dev lobby-identity — ISSUER (lobby/server) side. MUST NOT SHIP in a real client.
//
...
// rationale. Kept on the same DEBUG gate as the client partial for sample simplicity; a stricter build can
// narrow this file's gate further (or exclude it outright) without touching the client side.
#if DEBUG
using System;
...
namespace xpTURN.Samples.P2pSample
{
    internal static partial class P2pDevIdentity
    {
        ...
        // Key generation/rotation guide: Docs/Samples/DevIdentityKeys.md (changing the seed requires updating Client.cs:PublicKey too; keep identical to the Unity side).
