// Color/style constants for the FPNavMesh visualizer.
// Line-width constants are advisory only — ImmediateMesh lines have no width control.
#if TOOLS
using global::Godot;

namespace xpTURN.Klotho.Godot
{
    internal static class GodotFPNavMeshVisualizerStyles
    {
        // NavMesh geometry
