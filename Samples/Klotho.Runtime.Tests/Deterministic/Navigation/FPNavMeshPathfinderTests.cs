...
namespace xpTURN.Klotho.Deterministic.Navigation.Tests
{
    ...
    public class FPNavMeshPathfinderTests
    {
        ...
        public void FindPath_OutsideNavMesh_ReturnsFalse()
        {
            ...
            var mesh = Create4TriNavMesh();
            var query = new FPNavMeshQuery(mesh, log);
            var pf = new FPNavMeshPathfinder(mesh, query, log);
            ...
            Assert.IsTrue(log.Contains(KLogLevel.Error, "outside NavMesh"));
        }
        ...
        public void FindPath_BothPointsOutside_ReturnsFalse()
        {
            ...
            Assert.IsFalse(found);
            Assert.That(log.CountAt(KLogLevel.Error), Is.GreaterThanOrEqualTo(2));
        }
