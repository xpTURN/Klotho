...
namespace xpTURN.Klotho.Network.Tests
{
    ...
    public class KlothoConnectionLateJoinTests
    {
        ...
        public void LateJoin_Timeout_FiresOnFailed()
        {
            ...
            Assert.IsInstanceOf<JoinFailedException>(failReason, "Typed join failure");
            Assert.AreEqual(JoinFailReason.TimedOut, ((JoinFailedException)failReason).Reason);
        }
        ...
        public void LateJoin_DisconnectMidway_FiresOnFailed()
        {
            ...
            Assert.IsNotNull(failReason, "Fail callback fired");
            Assert.IsInstanceOf<JoinFailedException>(failReason, "Typed join failure");
            Assert.AreEqual(JoinFailReason.ConnectionLost, ((JoinFailedException)failReason).Reason);
        }
